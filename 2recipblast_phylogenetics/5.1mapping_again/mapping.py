...
# 10. create a VCF file
	...
	java -jar /nfs/LabShared/MarkPhuong/myprograms/bin/picard.jar MarkDuplicates INPUT={sample}_sorted_5.1.bam OUTPUT={sample}_5.1_md.bam REMOVE_DUPLICATES=TRUE ASSUME_SORTED=TRUE METRICS_FILE={sample}_5.1_md.metrics
	samtools mpileup -d 1000000 -u -I -t DP -t SP -B -f {ref} {sample}_5.1_md.bam | bcftools call -c - > {sample}_5.1.vcf
